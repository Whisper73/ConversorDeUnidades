...
public class UnidadesDeTemperatura extends javax.swing.JFrame {
    
    int xMouse , yMouse;
    Validaciones validar = new Validaciones();
    public UnidadesDeTemperatura() {
        initComponents();
    ...
    private void initComponents() {
        ...
        menuDe.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Kelvin (K)", "Celsius (°C)", "Fahrenheit (°F)", "Rankine (°R, °Ra)", " " }));
        ...
        menuA.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Kelvin (K)", "Celsius (°C)", "Fahrenheit (°F)", "Rankine (°R, °Ra)", " " }));
        ...
        convertirBntLayout.setVerticalGroup(
            convertirBntLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(convertirBntLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(convertirL, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
            ...
            .addGroup(backgroundLayout.createSequentialGroup()
                ...
                .addGroup(backgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(backgroundLayout.createSequentialGroup()
                        ...
                        .addGap(10, 10, 10)
                        .addComponent(menuDe, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(backgroundLayout.createSequentialGroup()
                        .addComponent(menuA, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(10, 10, 10)
                    ...
                    .addComponent(output, javax.swing.GroupLayout.PREFERRED_SIZE, 320, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(backgroundLayout.createSequentialGroup()
                        .addGap(100, 100, 100)
                        ...
                        .addGroup(backgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(backgroundLayout.createSequentialGroup()
                                .addGroup(backgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(menuDe, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(20, 20, 20)
                                .addGroup(backgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void convertirBntMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_convertirBntMouseClicked
        ...
        if(this.validar.validarNumeroconNegativo(this.input.getText())){    
        ...
        ConversorTemperatura ct = new ConversorTemperatura(inputTxt, index1, index2);
        ct.TemperaturaFinal();
        outputTxt=ct.getResultado();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UnidadesDeTemperatura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UnidadesDeTemperatura().setVisible(true);
            }
        });
    }
