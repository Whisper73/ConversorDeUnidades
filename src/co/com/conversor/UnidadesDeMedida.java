...
public class UnidadesDeMedida extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LpanelSup.setText("Conversor de Unidades de longitud.");
        ...
        menuDe.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Centimetros", "Milimetros", "Metro", "Kilometros", "Pie", "Pulgada" }));
        ...
        menuA.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Centimetros", "Milimetros", "Metro", "Kilometros", "Pie", "Pulgada" }));
    ...
    private void convertirBntMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_convertirBntMouseClicked
        ...
        ConversorUnidadesDeLongitud ul = new ConversorUnidadesDeLongitud(inputTxt, index1, index2);
        ul.ResultadoFinal();
        outputTxt=ul.getResultado();
